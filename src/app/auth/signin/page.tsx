    ...
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: "var(--bg)" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-black uppercase tracking-tighter text-white leading-none mb-3">
            Sign In to<br />
        ...
        {/* Error */}
        {params.error && (
          <div className="mb-6 px-5 py-4 rounded-xl border text-sm font-mono"
            style={{ background: "rgba(255,60,60,0.05)", borderColor: "rgba(255,60,60,0.2)", color: "#ff6b6b" }}>
        ...
        <div className="space-y-3">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 py-4 rounded-xl font-black text-xs uppercase tracking-widest transition-all hover:[border-color:var(--accent-border)]"
              style={{
                background: "var(--bg-2)",
