...
const jsonLd = [
  ...
  },
  {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `${AdminConfig.SITE_URL}/registry?search={search_term_string}`,
      },
  ...
  },
  {
    ...
    url: AdminConfig.SITE_URL,
    description:
      "Discovery and visibility platform for vibe-coded products. List once, get indexed, get found by VCs.",
    offers: [
  ...
  },
  {
    ...
    description:
      "A curated, living registry of vibe-coded products built by solo founders — each with a verified problem statement.",
  ...
  },
  {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What is Arcapush?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Arcapush is the home of vibe-coded products. Solo founders submit their product once — Arcapush creates an indexed page, adds structured data, and pushes it into the feed of VCs actively looking for early-stage products.",
        },
      },
      {
        "@type": "Question",
        name: "Who founded Arcapush?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Arcapush was founded by Mojeeb, a Web3 strategist and vibe coder. Learn more at mojeeb.xyz or follow @mojeebeth on X.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "How is Arcapush different from Product Hunt?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Arcapush is exclusively focused on vibe-coded products. Every listing requires a problem statement — not just marketing copy. This gives VCs investor-grade signal, not noise.",
        },
      },
      {
        "@type": "Question",
        name: "How do I list my product on Arcapush?",
        acceptedAnswer: {
          "@type": "Answer",
          text: `Founders can list their product for free at ${AdminConfig.SITE_URL}/submit. Featured and Pro visibility tiers are available at ${AdminConfig.SITE_URL}/pricing.`,
        },
      },
    ],
  },
      ...
      >
        <SessionProvider>
          <Web3Provider>
            ...
            <div className="fixed inset-0 z-[-1] pointer-events-none overflow-hidden" style={{ background: "var(--bg)" }}>
              <div
                className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] rounded-full"
                style={{ background: "rgba(232,255,71,0.025)", filter: "blur(140px)" }}
              />
              <div
                className="absolute bottom-[-10%] right-[-5%] w-[400px] h-[400px] rounded-full"
                style={{ background: "rgba(232,255,71,0.015)", filter: "blur(120px)" }}
              />
            </div>
