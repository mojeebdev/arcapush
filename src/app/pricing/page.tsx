...
const PIN_PACKAGES = [
  {
    label: "30 Mins", price: "5", value: 30, rotations: "90",
  ...
  {
    label: "1 Day", price: "25", value: 1440, rotations: "4,320",
  ...
  {
    label: "3 Days", price: "60", value: 4320, rotations: "12,960",
  ...
  {
    label: "1 Week", price: "100", value: 10080, rotations: "30,240",
  ...
  {
    label: "2 Weeks", price: "175", value: 20160, rotations: "60,480",
  ...
  {
    label: "1 Month", price: "299", value: 43200, rotations: "129,600",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {PIN_PACKAGES.map((plan) => (
          <motion.div
            key={plan.label}
            whileHover={{ y: -8 }}
            className={`relative rounded-[3rem] p-10 bg-white border flex flex-col shadow-card ${
              plan.featured
                ? 'border-[#4E24CF] shadow-[0_0_40px_rgba(78,36,207,0.10)]'
                : 'border-black/8'
            }`}
          >
            {plan.featured && (
              <span className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#4E24CF] text-white px-4 py-1 rounded-full text-[10px] font-black uppercase italic whitespace-nowrap">
                Most Popular
              </span>
            )}
            ...
            <div className="space-y-3 mt-auto">
              <button
                ...
                className="w-full py-4 rounded-2xl font-black text-[10px] bg-blue-500/8 border border-blue-500/20 text-blue-600 hover:bg-blue-600 hover:text-white transition-all uppercase tracking-widest disabled:opacity-30 disabled:cursor-not-allowed"
              >
                Pay with Base USDC
              </button>
              <button
                ...
                disabled={isProcessing || !selectedStartupId}
                className="w-full py-4 rounded-2xl font-black text-[10px] bg-zinc-900 text-white hover:bg-[#D4AF37] hover:text-black transition-all uppercase tracking-widest disabled:opacity-30 disabled:cursor-not-allowed"
              >
                Pay with Solana SOL
              </button>
            </div>
