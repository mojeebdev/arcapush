...
function buildUrl(startup: StartupCardProps["startup"]): string {
...
export function StartupCard({ startup, variant }: StartupCardProps) {
  const startupUrl    = buildUrl(startup);
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="relative lg:w-1/2 h-[220px] lg:h-[380px] overflow-hidden">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, var(--bg-2) 0%, rgba(239,237,230,0.5) 40%, transparent 100%)",
              }}
            />
            <div
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              {displayLogo && (
                <div
                  className="w-12 h-12 rounded-2xl overflow-hidden p-1.5 flex-shrink-0"
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <ShareButton startup={{ ...startup, categorySlug: startup.categorySlug ?? undefined }} />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="relative h-[180px] overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, var(--bg-2) 0%, rgba(239,237,230,0.3) 50%, transparent 100%)",
            }}
          />
          {/* top-right: indexed badge OR category — indexed takes priority */}
        ...
        <div className="p-8 flex-grow">
          <div className="flex items-center gap-3 mb-4">
            {displayLogo && (
              <div
                className="w-10 h-10 rounded-xl overflow-hidden p-1.5 transition-transform group-hover:scale-110 flex-shrink-0"
                style={{ border: "1px solid var(--border)", background: "var(--bg)" }}
              >
                <Image
                  src={displayLogo}
