...
export async function POST(
  ...
  try {
    ...
    if (startup.approved) {
      return NextResponse.json({ error: "Cannot reject an approved listing" }, { status: 400 });
    }
    ...
    <tr><td>
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:0 auto;background:#111;border:1px solid #222;border-radius:24px;overflow:hidden;">
        <tr><td style="padding:32px 36px 24px;border-bottom:1px solid #222;">
          <p style="margin:0 0 8px;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#e8ff47;font-weight:700;">Arcapush</p>
        ...
        <tr><td style="padding:32px 36px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr><td style="background:#1a1a1a;border:1px solid #2a2a2a;border-left:3px solid #e8ff47;border-radius:12px;padding:20px 24px;">
              <p style="margin:0 0 8px;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:#e8ff47;font-weight:700;">Feedback from the Arcapush team</p>
              <p style="margin:0;font-size:14px;color:#ccc;line-height:1.7;">${reason}</p>
            </td></tr>
          </table>
          <p style="margin:0 0 20px;font-size:14px;color:#888;line-height:1.7;">
            Address the feedback above and resubmit at any time — we'd love to have your product on the registry.
          </p>
          <table cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
            <tr><td style="border-radius:12px;background:#e8ff47;">
              <a href="https://arcapush.com/submit" style="display:inline-block;padding:14px 28px;font-size:11px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;color:#0a0a0a;text-decoration:none;">
                Resubmit Your Product →
              </a>
            </td></tr>
          </table>
          <p style="margin:0;font-size:13px;color:#555;line-height:1.7;">
            Questions? Reply to this email or find us on X at <a href="https://x.com/mojeebeth" style="color:#e8ff47;text-decoration:none;">@mojeebeth</a>.
          </p>
        </td></tr>
